...
BASE_LOOKUP_URL = 'http://conceptnet5.media.mit.edu/data/5.4'
BASE_SEARCH_URL = 'http://conceptnet5.media.mit.edu/data/5.4/search'
BASE_ASSOCIATION_URL = 'http://conceptnet5.media.mit.edu/data/5.4/assoc'
